...
class LikeProducerIntTest {
    ...
    @Test
    @DisplayName("Успешная отправка LikeEvent для поста в Kafka")
    void positive_producerLikePostEventSent() {
        consumer.subscribe(List.of(kafkaProps.topic().postLike()));
        ...
        ConsumerRecord<String, String> record =
                KafkaTestUtils.getSingleRecord(consumer, kafkaProps.topic().postLike(), Duration.ofMillis(5000));
