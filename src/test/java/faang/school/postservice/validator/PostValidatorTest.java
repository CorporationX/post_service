...
class PostValidatorTest {
    ...
    private PostDto postDtoWithLongContent;
    private PostDto postDtoWithEmptyContent;
    private PostValidator postValidator;

    @BeforeEach
    void setUp() {
        postDtoWithLongContent = PostDto.builder().content(getLongContent()).authorId(1L).build();
        postDtoWithEmptyContent = PostDto.builder().content("").authorId(1L).build();
