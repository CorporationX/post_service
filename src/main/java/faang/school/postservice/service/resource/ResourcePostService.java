...
import faang.school.postservice.exceptions.ForbiddenException;
...
public class ResourcePostService {
    ...
    private ResourceDto processSingleFile(Post post, MultipartFile file, ImageType type) throws IOException {
        ...
        Resource minioResource = minioService.uploadImage(
                imageProcessService.resizeImage(file, type),
                folder,
    ...
    private void validateImageFile(Post post, MultipartFile file) {
        ...
        if (originalFileName == null || !originalFileName.contains(".")) {
            throw new ForbiddenException("Your photo does not contain the required extension %s"
