...
public class PostController {
    ...
    @GetMapping("/unpublished/by-author-id")
    ...
    @GetMapping("/unpublished/by-project-id/{projectId}")
    public List<PostDto> getAllUnpublishedPostsByProject(@PathVariable("projectId") long projectId) {
        return postService.getAllUnpublishedPostsByProject(projectId);
    }

    @GetMapping("/published/by-author/{id}")
    public List<PostDto> getAllPublishedPostsByAuthor(@PathVariable("id") long authorId) {
        return postService.getAllPublishedPostsByAuthor(authorId);
    }

    @GetMapping("/published/by-project/{projectId}")
    public List<PostDto> getAllPublishedPostsByProject(@PathVariable("projectId") long projectId) {
